import { ReactElement, JSXElementConstructor, ReactNode, ReactPortal, PromiseLikeOfReactNode, MouseEventHandler } from "react";

export default function({children, ...props} : { children: string, active: boolean, onClick: MouseEventHandler }) {
    return (
